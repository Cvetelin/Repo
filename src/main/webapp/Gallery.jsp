			...
			jQuery(function($){
				$.supersized({
					...
					slides 					:  	[		//Slideshow Images
														{image : 'http://localhost/screen1318358633371.png', title : 'Day 3 by Emily Tebbetts'},  
														{image : 'http://buildinternet.s3.amazonaws.com/projects/supersized/3.1/slides/film-emily.jpg', title : 'Film by Emily Tebbetts'},  
														{image : 'http://buildinternet.s3.amazonaws.com/projects/supersized/3.1/slides/day2-emily.jpg', title : 'Day 2 by Emily Tebbetts', }  
												]
